/* include/godwin/config.h.  Generated from config.h.in by configure.  */
/* include/godwin/config.h.in.  Generated from configure.ac by autoheader.  */

#include <godwin/unconfig.h>
...
/* Define to 1 if you have the `zapata-users' library (-lzapata-users). */
#define HAVE_LIBZAPATA_USERS 1
...
/* Name of package */
#define PACKAGE "godwin"

/* Define to the address where bug reports for this package should be sent. */
#define PACKAGE_BUGREPORT "naazgull@dfz.pt"

/* Define to the full name of this package. */
#define PACKAGE_NAME "godwin"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "godwin 0.0.1-1"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "godwin"
